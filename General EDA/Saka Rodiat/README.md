...
**SAKA RODIAT OPEYEMI - Exploratory Data Analysis of the Producers Direct Smallholder Farmers Dataset**
...
The analysis is based on the Wefarm.csv dataset obtained from Producers Direct. Given the size of the dataset (~20 million records), the CSV file was converted into Parquet format to enable efficient querying and processing.
